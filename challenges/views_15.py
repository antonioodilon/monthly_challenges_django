...
def monthly_challenge(request, month):
    try:
        ...
        response_data = render_to_string("base_template_404errors.html")
        return response_data
        # return HttpResponseNotFound('<h1>Please insert a valid month.</h1>')
        # Generally speaking, it is not a good idea to have hardcoded html stuff like this inside of our views
...
def monthly_challenge_by_number(request, month):
    ...
    if month > len(months):
        response_data = render_to_string("base_template_404errors.html")
        return response_data
        # return HttpResponseNotFound("<h1>Please insert a valid month.</h1>")  # Generally speaking, it is not a
        # good idea to have hardcoded html stuff like this inside of our views
