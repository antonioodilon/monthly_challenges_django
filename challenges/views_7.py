...
def monthly_challenge(request, month):
    try:
        ...
        response_data = render_to_string("challenges/challenge.html")  # render_to_string will get the
        # contents of our html file, transform them into a string and then store that string inside our
